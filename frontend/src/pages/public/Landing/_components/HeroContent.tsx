    ...
    >
      <div className="relative w-full flex flex-col items-center my-10 md:my-22 perspective-2000">
        <div className="w-full text-center pointer-events-none select-none">
          ...
          >
            The Gateway <br />
            <div className="flex justify-center md:justify-between w-full max-w-212.5 mx-auto mt-[-5px] md:-mt-10 gap-4 md:gap-0">
              <span>to</span>
        ...
        >
          <div className="relative w-full h-full transform-gpu preserve-3d">
            <div className="relative w-full h-full z-0 overflow-hidden rounded-[20px] md:rounded-[30px]">
              <img src="/image/card.png" alt="On-Chainpass Card" className="absolute inset-0 w-full h-full object-contain pointer-events-none" />
            </div>
      ...
      <div className="w-full max-w-[750px] mx-auto text-center mt-[240px] sm:mt-[260px] md:mt-36 space-y-8 md:space-y-10 px-2 md:px-0">
        ...
        >
          <Button
            ...
            label="Explore On-Chainpass"
            variant="white"
            className=" w-fit! whitespace-nowrap px-4! py-3.5 md:py-4 rounded-[12px] md:rounded-[16px] text-[13px] md:text-base"
          />
        </motion.div>
      </div>
    </div>
