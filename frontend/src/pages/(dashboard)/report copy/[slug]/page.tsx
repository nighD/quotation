            ...
            <div className="w-full pb-12">
                <div className="sticky top-0 z-30 bg-[#F2E8E0] flex items-center justify-between gap-4 -mt-4 -mx-4 px-6  pb-4 border-b border-[#DCD0C5] mb-8">
                    <button
                        ...
                        className="bg-[#523C37] hover:bg-[#382b24] text-[#F2E8E0] px-4 py-2 rounded-lg font-['Inter'] text-[11px] font-semibold tracking-wider uppercase flex items-center gap-2 transition-all cursor-pointer shadow-xs active:scale-95 shrink-0"
                    >
                        <ArrowLeft size={14} />
