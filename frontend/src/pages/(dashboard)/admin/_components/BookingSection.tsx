...
export const BookingSection: React.FC<BookingSectionProps> = ({
  ...
  const isSubmitting = (bookingType: string) =>
    submittingBookingType === bookingType;
  const hasRequested = (bookingType: string) =>
    requestedBookingTypes.includes(bookingType);
        ...
        >
          <div>
              ...
              <img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1000&q=90";
                }}
              />
            </div>
            ...
            <p className="text-[#523C37] font-['Inter']! font-normal! text-[12px] leading-relaxed line-clamp-3">
              Dành cho doanh nghiệp xuất khẩu, nhà sản xuất và nhà giao dịch
              hàng hóa đang muốn thoát khỏi thế bị động — khi tài sản nằm trong
              kho nhưng dòng vốn vẫn phụ thuộc vào sàn nước ngoài và ngân hàng
              truyền thống. Hạ tầng on-chain đang mở ra cơ chế mới: lô hàng cà
              phê, gạo, hồ tiêu có thể được số hóa thành chứng từ có giá trị tài
              chính — xác thực độc lập, giao dịch được, và tiếp cận thẳng dòng
              vốn quốc tế mà không qua trung gian bảo lãnh.{" "}
            </p>
          </div>
          ...
          <div>
            <div className="w-full h-[209.41px] rounded-2xl overflow-hidden mb-3 group">
              <img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    "https://images.unsplash.com/photo-1517502884422-41eaead166d4?auto=format&fit=crop&w=1000&q=90";
                }}
              />
            </div>
            <h3 className="text-[22px] font-['Cormorant_Garamond']! font-semibold! text-[#1B1A16] mb-1.5">
            ...
            <p className="text-[#523C37] font-['Inter']! font-normal! text-[12px] leading-relaxed line-clamp-3">
              Dành cho doanh nghiệp phát triển bất động sản du lịch, chủ tài sản
              và nhà đầu tư đang bị kẹt giữa tài sản lớn và thanh khoản thấp —
              khi muốn huy động vốn quốc tế nhưng không có cấu trúc tài chính
              phù hợp. Hạ tầng on-chain cho phép phân nhỏ quyền sở hữu tài sản
              nghỉ dưỡng thành các đơn vị đầu tư có thể giao dịch — mở ra nhóm
              nhà đầu tư tổ chức quốc tế mà trước đây không thể tiếp cận do rào
              cản ticket size và pháp lý.
            </p>
          </div>
